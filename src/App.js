        ...
        <BrowserRouter>
          <Navbar/>
            <Routes>
              ...
              <Route exact path = "/general" element = {<News key="home" pageSize = {10} country = "in" category = "general"/>}></Route>     
              ...
              <Route exact path = "/health" element = {<News key="health" pageSize = {10} country = "in" category = "health"/>}></Route> {/* pageSize is the number of news in each page */}   
