...
export class News extends Component {
  ...
  async componentDidMount(){ //componentDidMount() keliye refer react component lifecycle notes. we have made it async
  ...
  render() {
    return (
      <div>
        <div>
            <h2 className = "text-center" style = {{margin: "30px"}} >NewsMonkey - Top Headlines</h2>
